(function(){
  ...
  function injetarCSS(){
    var css=[
      ...
      ".fdc-v10-calendar{border:1px solid #e0dcda;border-radius:10px;padding:11px}.fdc-v10-cal-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:9px}.fdc-v10-cal-head strong{font-size:13px}.fdc-v10-cal-nav{width:29px;height:29px;border:1px solid #ddd;background:#fff;border-radius:7px;cursor:pointer}.fdc-v10-cal-grid{display:grid;grid-template-columns:repeat(7,1fr);gap:4px}.fdc-v10-cal-dow{font-size:9px;color:#999;text-align:center;padding:3px}.fdc-v10-day{font-size:10px;text-align:center;padding:8px 1px;border-radius:8px;border:1px solid #e7a1a1;background:#fdeaea;color:#a72d2d;font-weight:700;width:100%}.fdc-v10-day.disp{background:#edf7f0;color:#23663a;border-color:#9fd0ac;cursor:pointer;font-weight:800}.fdc-v10-day.sel{background:#026dfb;color:#fff;border-color:#026dfb}.fdc-v10-day.empty{visibility:hidden;border:0;background:transparent}.fdc-v10-legend{display:flex;gap:10px;flex-wrap:wrap;margin-top:8px;font-size:9px;color:#777}.fdc-v10-lg{display:flex;align-items:center;gap:4px}.fdc-v10-sw{width:10px;height:10px;border-radius:3px}.fdc-v10-sw.g{background:#edf7f0;border:1px solid #9fd0ac}.fdc-v10-sw.r{background:#fdeaea;border:1px solid #e7a1a1}.fdc-v10-sw.w{background:#026dfb}",
      ".fdc-v10-datehint{margin-top:9px;background:#fafafa;border:1px solid #ece9e7;padding:9px;border-radius:8px;font-size:10.5px;color:#666;line-height:1.45}.fdc-v10-times-title{font-size:11.5px;font-weight:900;margin:11px 0 7px}.fdc-v10-times{display:grid;gap:7px}.fdc-v10-time{display:flex;align-items:center;gap:9px;border:1.5px solid #9fd0ac;background:#edf7f0;color:#2e6b42;border-radius:9px;padding:10px;cursor:pointer}.fdc-v10-time.sel{border-color:#026dfb;background:#eef5ff;color:#026dfb}.fdc-v10-time.bloq{border-color:#e7a1a1;background:#fdeaea;color:#9d2d2d;cursor:default}.fdc-v10-mark{width:19px;height:19px;border-radius:50%;border:2px solid #67a877;background:#fff;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:900;flex:none}.fdc-v10-time.bloq .fdc-v10-mark{border:0;background:#b53333;color:#fff}.fdc-v10-time b{display:block;font-size:11.5px}.fdc-v10-time small{display:block;color:#777;font-size:9.5px;margin-top:2px}.fdc-v10-time.sel .fdc-v10-mark{border-color:#026dfb;color:#026dfb}",
      ...
      ".fdc-v10-terms{background:#3a3a3a;border-radius:9px;padding:13px;overflow:hidden}.fdc-v10-terms.aceito{background:#72cd41}.fdc-v10-terms ul{list-style:none;padding:0 5px 0 0;margin:0 0 10px;height:170px;max-height:170px;overflow-y:auto;overflow-x:hidden;scrollbar-width:thin;scrollbar-color:rgba(255,255,255,.42) transparent}.fdc-v10-terms ul::-webkit-scrollbar{width:6px}.fdc-v10-terms ul::-webkit-scrollbar-track{background:transparent}.fdc-v10-terms ul::-webkit-scrollbar-thumb{background:rgba(255,255,255,.42);border-radius:4px}.fdc-v10-terms li{font-size:10.5px;color:#fff;line-height:1.5;padding:4px 0 4px 16px;position:relative}.fdc-v10-terms li:before{content:'•';position:absolute;left:0;color:rgba(255,255,255,.65)}.fdc-v10-check{display:flex;align-items:center;gap:6px;color:#fff;font-size:10.5px;font-weight:700;cursor:pointer}.fdc-v10-check input{accent-color:#fff}",
    ...
    div.innerHTML=[
      ...
      '<div class="fdc-v10-content">',
        ...
        '<section class="fdc-v10-pane" id="fdc-v10-s4">',
          ...
          '</div>',
          '<div id="fdc-v10-foto-resumo" class="fdc-v10-person-card" style="display:none">',
            '<div class="fdc-v10-person-title">📸 Fotos</div>',
            '<div class="fdc-v10-helper">As fotos já foram selecionadas no anúncio e fazem parte da personalização deste pedido.</div>',
          '</div>',
  ...
  function fdcV10AtualizarFotosResumo(){
    var box=document.getElementById("fdc-v10-foto-resumo");
    if(!box)return;
    var mostrar=false;
    try{
      var ids=JSON.parse(sessionStorage.getItem("fd_fotos_pendentes")||"[]");
      mostrar=Array.isArray(ids)&&ids.length>0;
    }catch(e){}
